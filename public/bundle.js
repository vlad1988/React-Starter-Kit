...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AddForm = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddForm = function (_React$Component) {
	  ...
	  function AddForm() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(AddForm).apply(this, arguments));
	  }
	  ...
	  _createClass(AddForm, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          { onClick: this.uploadTodos.bind(null, dispatch) },
	          'Подгрузи тудуськи'
	        )
	      );
	    }
	    ...
	    key: 'uploadTodos',
	    value: function uploadTodos(dispatch) {
	      // dispatch(receiveTodos('sdsdsd'));
	      fetch('/todos.json').then(function (response) {
	        return response.json();
	      }).then(function (json) {
	        dispatch((0, _actions.receiveTodos)(json));
	      }).catch(function (ex) {
	...
	AddForm = (0, _reactRedux.connect)(select)(AddForm);
...
/***/ function(module, exports) {
	...
	var completeTodo = exports.completeTodo = function completeTodo(id, completed) {
	  return {
	    type: 'COMPLETE_TODO',
	    id: id,
	    completed: completed
	...
	var receiveTodos = exports.receiveTodos = function receiveTodos(id) {
	  return {
	    type: 'RECEIVE_TODOS',
	    id: id
	  };
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    value: function render() {
	      ...
	      return(
	        ...
	        _react2.default.createElement(
	          'ul',
	          null,
	          this.props.todos.todo.map(function (t) {
	            return _react2.default.createElement(
	              'li',
	              { key: t.id },
	              t.id,
	              ...
	              _react2.default.createElement(
	                'button',
	                { onClick: function onClick() {
	                    dispatch((0, _actions.completeTodo)(t.id, t.completed));
	                  } },
	                t.completed ? _react2.default.createElement(
	                  'div',
	                  null,
	                  'Completed'
	                ) : _react2.default.createElement(
	...
	TodoList = (0, _reactRedux.connect)()(TodoList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _goals = __webpack_require__(187);
